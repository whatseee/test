...
typedef struct _scps_np_rqts
  {
	...
	unsigned int mpls[MAX_MPLS_DEPTH];
	 unsigned int mpls_depth;
    int recv_tap_if;
    int peer_tap_if;
    uint32_t pacing_rate;
    uint32_t pre_send_time;
    uint32_t sned_start_time;
    uint32_t send_end_time;
