...
#define MAX_LL_QUEUE_ELEMENTS 	200000
...
#define SIZE_OF_8021Q_TAG			4
#define SIZE_OF_MPLS_TAG         4
...
int ll_nbreceive (struct _interface *interface, struct
		  ...
		  int *offset);
struct _interface *create_interface (spanner_ip_addr local_addr, spanner_ip_addr span_addr);
