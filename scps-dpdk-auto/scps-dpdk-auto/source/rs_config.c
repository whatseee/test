...
int_hndlr ()
{
  ...
  //if(fp_timer) fclose(fp_timer);
	if(fp_cksum) fclose(fp_cksum);        //added by YGX
  exit (-1);
}
...
gateway_Init ()
{
  ...
  gw_ifs.aif_buf = 65535;
  gw_ifs.aif_rate = 1000000000;
  gw_ifs.aif_cc = 1;
  gw_ifs.aif_mtu = 1400;
  gw_ifs.bif_buf = 65537;
  gw_ifs.bif_rate =520000000;
  gw_ifs.bif_cc = 0;
  gw_ifs.bif_mtu = 1400;
  ...
  gw_ifs.aif_tcponly = 1;
  gw_ifs.bif_tcponly = 0x0;
